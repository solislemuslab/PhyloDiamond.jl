# PhyloDiamond.jl <picture> <source media="(prefers-color-scheme: dark)" srcset="docs/src/logo_unrooted_trans.png"><img alt="phylodiamond logo" src="docs/src/logo_unrooted_trans.png" align=right width="600"></picture>
