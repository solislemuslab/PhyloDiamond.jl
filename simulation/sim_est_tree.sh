for ((i = 0 ; i < 30 ; i++)); do #replicate
    for ((j = 1000 ; j < 10001 ; j*=10)); do #number of estimated gene trees: 1000, 10000
        for ((k = 500 ; k < 2001 ; k*=4)); do #length of gene sequences: 500, 2000
